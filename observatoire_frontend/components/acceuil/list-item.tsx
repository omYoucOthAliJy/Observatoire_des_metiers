      ...
      <div className="flex">
        {item.status == "submit" ? (
          ...
          <>
            <button
              onClick={onClickEdit}
              className="w-8 h-8 flex items-center justify-center bg-[#3E1F94] rounded-full"
            ...
            <button
              ...
              className="w-8 h-8 ml-2 flex items-center justify-center bg-[#D71A1A] rounded-full"
